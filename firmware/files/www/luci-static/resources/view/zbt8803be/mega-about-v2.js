		...
		const root = E('div', { 'class': 'zma-page' }, [
			...
			E('section', { id: 'zma-features', 'class': 'zma-section' }, [
				...
				E('div', { 'class': 'zma-grid zma-features' }, [
					feature('signal', 'Two modems. Independent control.', 'QModem', 'Manage Modem 1 and Modem 2 by physical slot—not by whichever wwan number Linux happens to assign at boot.', [
						...
						'Advanced 5G & Network Mode reads the modem before showing Automatic preferred, Automatic, NSA only or SA only. Mega defaults direct T-Mobile US service to NSA for LTE-plus-5G aggregation and leaves both modes available elsewhere. Applying an active mode makes no modem write; every choice preserves the band lists.',
			...
			E('section', { id: 'zma-speedify', 'class': 'zma-section zma-speedify' }, [
				...
				E('div', { 'class': 'zma-speedify-steps' }, [
					...
					E('article', {}, [E('span', {}, '3'), E('div', {}, [E('h3', {}, _('You choose the account and policy')), E('p', {}, _('Complete your own Speedify sign-in and connection settings. Mega opens the official application as a top-level page so a mobile browser cannot discard its login iframe while the account provider is open. The proprietary service remains separately licensed, and this page does not assert it is signed in or bonding.'))])])
				])
			]),
