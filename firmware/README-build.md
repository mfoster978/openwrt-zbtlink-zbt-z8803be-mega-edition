...
- Speedify bootstrap and service: `firmware/files/etc/uci-defaults/98-speedify-bootstrap`, `firmware/files/etc/init.d/speedify-installer`, `firmware/files/usr/sbin/speedify-installer-loop`
...
- Switched to a release-parity baseline config derived from `0xFar5eer/openwrt25.12_ZBT_Z8803BE` `v25.12.021`.
